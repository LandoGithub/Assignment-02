...
public class LibraryTester {
	...
	void setUp() throws Exception {
		...
		mediumLib.addAll("C:\\Code\\Assignment-02\\Assignment02\\src\\Mushroom_Publishing.txt");
	...
	@Test
	public void testSmallLibraryNoBooksLookupHolder() {
		ArrayList<LibraryBook> booksCheckedOut = smallLib.lookup("Jane Doe");
	...
	@Test
	public void testSmallLibraryBookDoesntExistCheckout() {
		assertFalse(smallLib.checkout(23743827492728L, "Jane Doe", 1, 1, 2008));
	}
	...
	@Test
	public void testSmallLibraryFalseCheckinISBN() {
	...
	@Test
	public void testSmallLibraryTrueCheckinHolder() {
		smallLib.checkout(9780330351690L, "Jane Doe", 1, 1, 2008);
